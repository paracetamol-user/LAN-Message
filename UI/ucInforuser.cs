...
namespace UI
{
    public partial class ucInforuser : UserControl
    {
        UserForm frmMain;
        User user;
        public ucInforuser()
		...
		public ucInforuser(UserForm frmMain)
		{
		...
		public void _LoadInforUser(User user, List<ucFileShow> listfileShows)
		{
			this.user = user;
		...
		private void lbaddfriend_Click_1(object sender, EventArgs e)
        {
			this.SendAddFriendToServer();
			MessageBox.Show("Đã gửi lời mời kết bạn");
		}

        private void pnaddfriend_Click_1(object sender, EventArgs e)
        {
			this.SendAddFriendToServer();
			MessageBox.Show("Đã gửi lời mời kết bạn");
		}
